      ...
      <div style={{ maxWidth: 620, margin: "0 auto", position: "relative", zIndex: 1 }}>
        ...
        {screen === "start" && (
          ...
          >
            ...
            gern auf TikTok{" "}
            <a
              href="https://www.tiktok.com/@adrabic"
              target="_blank"
              rel="noopener noreferrer"
              style={{ color: C.gold, fontWeight: 600, textDecoration: "underline" }}
            >
              @adrabic
            </a>{" "}
...
function StartScreen({
  ...
  const pickBtn = (active) => ({
    ...
    background: active ? "rgba(227,200,138,0.14)" : C.panel2,
    color: C.ink,
    cursor: "pointer",
    textAlign: "left",
    transition: "all .15s",
    ...
    <div>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                height: 30,
                borderRadius: 999,
                border: `1px solid ${autoMode ? C.accent : C.line}`,
                background: autoMode ? "rgba(227,200,138,0.25)" : C.panel2,
                position: "relative",
                cursor: "pointer",
                transition: "all .15s",
              }}
            >
              <span
                style={{
                  ...
                  height: 22,
                  borderRadius: "50%",
                  background: autoMode ? C.accent : C.sub,
                  transition: "left .15s",
                }}
              />
            </button>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                height: 30,
                borderRadius: 999,
                border: `1px solid ${followMode ? C.accent : C.line}`,
                background: followMode ? "rgba(227,200,138,0.25)" : C.panel2,
                position: "relative",
                cursor: "pointer",
                transition: "all .15s",
              }}
            >
              <span
                style={{
                  ...
                  height: 22,
                  borderRadius: "50%",
                  background: followMode ? C.accent : C.sub,
                  transition: "all .15s",
                }}
              />
            </button>
      ...
      <button
        ...
        style={{
          ...
          fontWeight: 700,
          cursor: "pointer",
          boxShadow: "0 6px 20px rgba(227,200,138,.35)",
        }}
      >
        Los geht's
      </button>
      ...
      {follow ? (
        <button
          ...
          style={{
            ...
            borderRadius: 14,
            border: `1.5px solid ${C.gold}`,
            background: paused ? `linear-gradient(180deg, ${C.accent}, ${C.accentDark})` : "transparent",
            color: paused ? C.accentInk : C.gold,
            fontSize: 16,
            fontWeight: 700,
            cursor: "pointer",
            marginBottom: 12,
